...
#
#  num_bins - integer, the number of edges added in the filtration * * of order complexes * * that produced the persistence diagrams DGMS.
...
# Nikki 8/30/23: When the filtration is NOT taken for order complexes, instead an arbitrary symmetric matrix, this value should be the 
# - - - OH NO! SHOULD SEPARATE THESE USES BC RIGHT NOW USING num_bins as an int to make an array size
# - - - AND ALSO THE MAXIMUM VALUE OF THE RANGE FOR WHICH TO MAKE BETTI CURVES FROM THE PERSISTENCE DIAGRAMS !*!*! 
#
# RETURNS:
#[BCs, edge_densities] 
#
